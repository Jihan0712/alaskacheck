document.addEventListener("DOMContentLoaded", () => {
  ...
  // Canvas Image Processing & Compression
  function capturePhoto() {
    ...
    // Set a compressed native resolution to prevent Google Sheets payload rejections
    canvas.width = 540;  
    canvas.height = 810; 
    ...
    let yOffset = canvas.height - 120; // Position near bottom
    lines.forEach(line => {
    ...
    // Export heavily compressed JPEG to keep Base64 string under 50k characters for Zapier/GSheets
